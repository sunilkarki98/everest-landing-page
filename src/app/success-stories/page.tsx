...
import { Quote, Star, ArrowRight, Target, Lightbulb, Trophy } from "lucide-react";
      ...
      <section className="py-20 bg-primary text-white relative overflow-hidden">
        ...
        <Container className="relative z-10 text-center max-w-4xl">
          ...
          <p className="text-white/80 text-lg sm:text-xl mb-10 leading-relaxed">
            Join thousands of students who have successfully achieved their education and migration goals with {siteConfig.shortName}. Book a free consultation today and take the first step towards your future.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <a 
              href="#contact-us" 
              className="inline-flex items-center justify-center h-14 px-8 rounded-full font-bold text-lg bg-accent text-primary hover:bg-gold transition-colors duration-300 shadow-xl hover:shadow-[0_0_20px_hsl(var(--accent)/0.5)] group"
            >
