...
const CallToAction: React.FC<CallToActionProps> = ({
  eyebrowText = "Ready to Start Your Journey?",
  title,
  description = "Book a free consultation with our experienced education and migration advisors. Get personalized guidance tailored to your goals.",
  primaryButtonText = "Book Free Consultation",
  primaryButtonLink = "https://condat.com.au/condat/318/customer?method=website",
  secondaryButtonText = "Chat on WhatsApp",
  secondaryButtonLink = "https://wa.me/61406000815",
        ...
        <div className="flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3">
              <a
                ...
                className="group relative inline-flex items-center justify-center gap-2 px-6 py-3 bg-accent text-primary font-bold text-sm rounded-xl overflow-hidden shadow-lg hover:shadow-xl hover:-translate-y-0.5 transition-all duration-300 w-full sm:w-auto"
              >
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-2 px-6 py-3 bg-white/10 backdrop-blur-sm text-white font-bold text-sm rounded-xl border border-white/20 hover:bg-white/20 hover:-translate-y-0.5 transition-all duration-300 w-full sm:w-auto"
              >
                {showSecondaryIcon && (
          ...
          >
            ...
            <div className="text-center">
              <h4 className="text-white font-bold text-sm">Scan to Connect</h4>
