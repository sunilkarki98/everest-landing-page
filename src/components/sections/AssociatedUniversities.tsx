...
import { associatedUniversities as universities } from "@/data/home";
...
export default function AssociatedUniversities() {
  ...
  return (
    <section id="universities" className="bg-white py-12 overflow-hidden border-b border-border/40">
